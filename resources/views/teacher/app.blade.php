            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="{{ route('teacher.profile') }}"><i class="fa fa-user fa-fw"></i> تعديل الملف الشخصى</a>
                        </li>
                        <li><a href="{{ route('teacher.password.change') }}"><i class="fa fa-gear fa-fw"></i> تغيير كلمة المرور</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="{{ route('teacher.logout') }}"><i class="fa fa-sign-out fa-fw"></i> تسجيل خروج</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
