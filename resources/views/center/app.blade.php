            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="{{ route('center.profile') }}"><i class="fa fa-user fa-fw"></i> تعديل الملف الشخصى</a>
                        </li>
                        <li><a href="{{ route('center.password.change') }}"><i class="fa fa-gear fa-fw"></i> تغيير كلمة المرور</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="{{ route('center.logout') }}"><i class="fa fa-sign-out fa-fw"></i> تسجيل خروج</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<a class="active" href="{{ route('settings') }}"><i class="fa fa-dashboard fa-fw"></i><b> الاعدادات</b></a>
                         ...
                         <li>
                            <a class="active" href="{{ route('documents') }}"><i class="fa fa-dashboard fa-fw"></i><b> ملازم الطلاب</b></a>
                        </li>
                        <li>
                            <a class="active" href="{{ route('messages') }}"><i class="fa fa-dashboard fa-fw"></i><b>الرسائل</b></a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
