...
<div class="container">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
					  <form role="form" method="POST" action="{{ route('student.login') }}" novalidate>
        {{ csrf_field() }}
                            <fieldset>
        ...
        <a class="btn btn-link" href="{{ route('student.password.email') }}"><b>اعادة تهيئة كلمة المرور</b></a>
                            </fieldset>
                        </form>
                    </div>
                </div>
